...
<form method="post" action="<?= base_url()?>index.php/admin/update_live_db_settings" id="" enctype="multipart/form-data">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="section">
             <label class="field">
                 <?php echo form_error('dbprefix'); ?>
                <input type="text" name="dbprefix"   class="gui-input" placeholder="Data Base PreFix"
                value="<?php  if(isset($data->dbprefix)){echo $data->dbprefix ;}else{echo set_value('dbprefix'); }?> ">
            </label>
          </div>
       </div>
       <div class="col-md-6">
